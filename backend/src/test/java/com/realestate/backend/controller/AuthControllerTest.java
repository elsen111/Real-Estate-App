...
class AuthControllerTest {
    ...
    void registerUser_returnsCreated_withDefaultBuyerType() {
        ...
        assertThat(response.getBody().getMessage())
                .isEqualTo(
                        "User registered successfully as a buyer"
                );
    ...
    void registerAgencyOwner_returnsCreated_withAgencyOwner() {
        ...
        AgencyRegisterRequest agency =
                AgencyRegisterRequest.builder()
                        .agencyName("Prime Realty")
                        .agencyDescription("Real estate agency")
                        .agencyBusinessEmail("info@primerealty.com")
                        .agencyBusinessPhone("+994125551122")
                        .agencyWebsiteUrl("https://primerealty.com")
                        .agencyCity("Baku")
        ...
        ResponseEntity<ApiResponse<AuthResponse>> response =
                controller.registerAgencyOwner(
                        request,
                        servletRequest
                );
        ...
        assertThat(response.getBody().getMessage())
                .isEqualTo(
                        "Agency owner registered successfully"
                );
    ...
    void refreshToken_returnsOk_withNewTokens() {
        ...
        assertThat(response.getBody().getMessage())
                .isEqualTo("Token refreshed successfully");
    ...
    void changePassword_returnsOk_withNoData() {
        ...
        assertThat(response.getBody().getMessage())
                .isEqualTo("Password successfully changed.");
    ...
    void forgotPassword_returnsOk_withNoData() {
        ...
        assertThat(response.getBody().getMessage())
                .isEqualTo(
                        "If the email has been registered, an OTP has been sent."
                );
