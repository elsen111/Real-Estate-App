...
public interface AuthMapper {
    ...
    @Mapping(target = "email", source = "agencyBusinessEmail", qualifiedByName = "normalize")
    @Mapping(target = "phoneNumber", source = "agencyBusinessPhone", qualifiedByName = "normalize")
    @Mapping(target = "website", source = "agencyWebsiteUrl", qualifiedByName = "normalize")
    @Mapping(target = "city", source = "agencyCity", qualifiedByName = "normalize")
    @Mapping(target = "address", source = "agencyAddress", qualifiedByName = "normalize")
    @Mapping(target = "status", expression = "java(com.realestate.backend.enums.AgencyStatus.PENDING)")
    AgencyEntity toAgencyEntity(AgencyRegisterRequest request);
